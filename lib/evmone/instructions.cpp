...
constexpr op_table create_op_table_frontier() noexcept
{
    ...
    for (auto& t : table)
        t = {op_undefined, nullptr, 0, 0, 0};

    table[OP_STOP] = {op_stop, nullptr, 0, 0, 0};
    table[OP_ADD] = {op<add>, nullptr, 3, 2, -1};
    table[OP_MUL] = {op<mul>, nullptr, 5, 2, -1};
    table[OP_SUB] = {op<sub>, nullptr, 3, 2, -1};
    table[OP_DIV] = {op<div>, nullptr, 5, 2, -1};
    table[OP_SDIV] = {op<sdiv>, nullptr, 5, 2, -1};
    table[OP_MOD] = {op<mod>, nullptr, 5, 2, -1};
    table[OP_SMOD] = {op<smod>, nullptr, 5, 2, -1};
    table[OP_ADDMOD] = {op<addmod>, nullptr, 8, 3, -2};
    table[OP_MULMOD] = {op<mulmod>, nullptr, 8, 3, -2};
    table[OP_EXP] = {op<exp>, nullptr, 10, 2, -1};
    table[OP_SIGNEXTEND] = {op<signextend>, nullptr, 5, 2, -1};
    table[OP_LT] = {op<lt>, nullptr, 3, 2, -1};
    table[OP_GT] = {op<gt>, nullptr, 3, 2, -1};
    table[OP_SLT] = {op<slt>, nullptr, 3, 2, -1};
    table[OP_SGT] = {op<sgt>, nullptr, 3, 2, -1};
    table[OP_EQ] = {op<eq>, nullptr, 3, 2, -1};
    table[OP_ISZERO] = {op<iszero>, nullptr, 3, 1, 0};
    table[OP_AND] = {op<and_>, nullptr, 3, 2, -1};
    table[OP_OR] = {op<or_>, nullptr, 3, 2, -1};
    table[OP_XOR] = {op<xor_>, nullptr, 3, 2, -1};
    table[OP_NOT] = {op<not_>, nullptr, 3, 1, 0};
    table[OP_BYTE] = {op<byte>, nullptr, 3, 2, -1};
    table[OP_SHA3] = {op<sha3>, nullptr, 30, 2, -1};
    table[OP_ADDRESS] = {op<address>, nullptr, 2, 0, 1};
    table[OP_BALANCE] = {op<balance>, nullptr, 20, 1, 0};
    table[OP_ORIGIN] = {op<origin>, nullptr, 2, 0, 1};
    table[OP_CALLER] = {op<caller>, nullptr, 2, 0, 1};
    table[OP_CALLVALUE] = {op<callvalue>, nullptr, 2, 0, 1};
    table[OP_CALLDATALOAD] = {op<calldataload>, nullptr, 3, 1, 0};
    table[OP_CALLDATASIZE] = {op<calldatasize>, nullptr, 2, 0, 1};
    table[OP_CALLDATACOPY] = {op<calldatacopy>, nullptr, 3, 3, -3};
    table[OP_CODESIZE] = {op<codesize>, nullptr, 2, 0, 1};
    table[OP_CODECOPY] = {op<codecopy>, nullptr, 3, 3, -3};
    table[OP_GASPRICE] = {op<gasprice>, nullptr, 2, 0, 1};
    table[OP_EXTCODESIZE] = {op<extcodesize>, nullptr, 20, 1, 0};
    table[OP_EXTCODECOPY] = {op<extcodecopy>, nullptr, 20, 4, -4};
    table[OP_BLOCKHASH] = {op<blockhash>, nullptr, 20, 1, 0};
    table[OP_COINBASE] = {op<coinbase>, nullptr, 2, 0, 1};
    table[OP_TIMESTAMP] = {op<timestamp>, nullptr, 2, 0, 1};
    table[OP_NUMBER] = {op<number>, nullptr, 2, 0, 1};
    table[OP_DIFFICULTY] = {op<difficulty>, nullptr, 2, 0, 1};
    table[OP_GASLIMIT] = {op<gaslimit>, nullptr, 2, 0, 1};
    table[OP_POP] = {op<pop>, nullptr, 2, 1, -1};
    table[OP_MLOAD] = {op<mload>, nullptr, 3, 1, 0};
    table[OP_MSTORE] = {op<mstore>, nullptr, 3, 2, -2};
    table[OP_MSTORE8] = {op<mstore8>, nullptr, 3, 2, -2};
    table[OP_SLOAD] = {op<sload>, nullptr, 50, 1, 0};
    table[OP_SSTORE] = {op_sstore, nullptr, 0, 2, -2};
    table[OP_JUMP] = {op_jump, nullptr, 8, 1, -1};
    table[OP_JUMPI] = {op_jumpi, nullptr, 10, 2, -2};
    table[OP_PC] = {op_pc, nullptr, 2, 0, 1};
    table[OP_MSIZE] = {op<msize>, nullptr, 2, 0, 1};
    table[OP_GAS] = {op_gas, nullptr, 2, 0, 1};
    table[OPX_BEGINBLOCK] = {opx_beginblock, nullptr, 1, 0, 0};  // Replaces JUMPDEST.

    for (auto op = size_t{OP_PUSH1}; op <= OP_PUSH8; ++op)
        table[op] = {op_push_small, nullptr, 3, 0, 1};
    for (auto op = size_t{OP_PUSH9}; op <= OP_PUSH32; ++op)
        table[op] = {op_push_full, nullptr, 3, 0, 1};

    table[OP_DUP1] = {op<dup<OP_DUP1>>, nullptr, 3, 1, 1};
    table[OP_DUP2] = {op<dup<OP_DUP2>>, nullptr, 3, 2, 1};
    table[OP_DUP3] = {op<dup<OP_DUP3>>, nullptr, 3, 3, 1};
    table[OP_DUP4] = {op<dup<OP_DUP4>>, nullptr, 3, 4, 1};
    table[OP_DUP5] = {op<dup<OP_DUP5>>, nullptr, 3, 5, 1};
    table[OP_DUP6] = {op<dup<OP_DUP6>>, nullptr, 3, 6, 1};
    table[OP_DUP7] = {op<dup<OP_DUP7>>, nullptr, 3, 7, 1};
    table[OP_DUP8] = {op<dup<OP_DUP8>>, nullptr, 3, 8, 1};
    table[OP_DUP9] = {op<dup<OP_DUP9>>, nullptr, 3, 9, 1};
    table[OP_DUP10] = {op<dup<OP_DUP10>>, nullptr, 3, 10, 1};
    table[OP_DUP11] = {op<dup<OP_DUP11>>, nullptr, 3, 11, 1};
    table[OP_DUP12] = {op<dup<OP_DUP12>>, nullptr, 3, 12, 1};
    table[OP_DUP13] = {op<dup<OP_DUP13>>, nullptr, 3, 13, 1};
    table[OP_DUP14] = {op<dup<OP_DUP14>>, nullptr, 3, 14, 1};
    table[OP_DUP15] = {op<dup<OP_DUP15>>, nullptr, 3, 15, 1};
    table[OP_DUP16] = {op<dup<OP_DUP16>>, nullptr, 3, 16, 1};

    table[OP_SWAP1] = {op<swap<OP_SWAP1>>, nullptr, 3, 2, 0};
    table[OP_SWAP2] = {op<swap<OP_SWAP2>>, nullptr, 3, 3, 0};
    table[OP_SWAP3] = {op<swap<OP_SWAP3>>, nullptr, 3, 4, 0};
    table[OP_SWAP4] = {op<swap<OP_SWAP4>>, nullptr, 3, 5, 0};
    table[OP_SWAP5] = {op<swap<OP_SWAP5>>, nullptr, 3, 6, 0};
    table[OP_SWAP6] = {op<swap<OP_SWAP6>>, nullptr, 3, 7, 0};
    table[OP_SWAP7] = {op<swap<OP_SWAP7>>, nullptr, 3, 8, 0};
    table[OP_SWAP8] = {op<swap<OP_SWAP8>>, nullptr, 3, 9, 0};
    table[OP_SWAP9] = {op<swap<OP_SWAP9>>, nullptr, 3, 10, 0};
    table[OP_SWAP10] = {op<swap<OP_SWAP10>>, nullptr, 3, 11, 0};
    table[OP_SWAP11] = {op<swap<OP_SWAP11>>, nullptr, 3, 12, 0};
    table[OP_SWAP12] = {op<swap<OP_SWAP12>>, nullptr, 3, 13, 0};
    table[OP_SWAP13] = {op<swap<OP_SWAP13>>, nullptr, 3, 14, 0};
    table[OP_SWAP14] = {op<swap<OP_SWAP14>>, nullptr, 3, 15, 0};
    table[OP_SWAP15] = {op<swap<OP_SWAP15>>, nullptr, 3, 16, 0};
    table[OP_SWAP16] = {op<swap<OP_SWAP16>>, nullptr, 3, 17, 0};

    table[OP_LOG0] = {op_log<OP_LOG0>, nullptr, 1 * 375, 2, -2};
    table[OP_LOG1] = {op_log<OP_LOG1>, nullptr, 2 * 375, 3, -3};
    table[OP_LOG2] = {op_log<OP_LOG2>, nullptr, 3 * 375, 4, -4};
    table[OP_LOG3] = {op_log<OP_LOG3>, nullptr, 4 * 375, 5, -5};
    table[OP_LOG4] = {op_log<OP_LOG4>, nullptr, 5 * 375, 6, -6};

    table[OP_CREATE] = {op_create<EVMC_CREATE>, nullptr, 32000, 3, -2};
    table[OP_CALL] = {op_call<EVMC_CALL>, nullptr, 40, 7, -6};
    table[OP_CALLCODE] = {op_call<EVMC_CALLCODE>, nullptr, 40, 7, -6};
    table[OP_RETURN] = {op_return<EVMC_SUCCESS>, nullptr, 0, 2, -2};
    table[OP_INVALID] = {op_invalid, nullptr, 0, 0, 0};
...
constexpr op_table create_op_table_homestead() noexcept
{
    ...
    table[OP_DELEGATECALL] = {op_call<EVMC_DELEGATECALL>, nullptr, 40, 6, -5};
    return table;
}
...
constexpr op_table create_op_table_byzantium() noexcept
{
    ...
    table[OP_RETURNDATASIZE] = {op<returndatasize>, nullptr, 2, 0, 1};
    table[OP_RETURNDATACOPY] = {op<returndatacopy>, nullptr, 3, 3, -3};
    table[OP_STATICCALL] = {op_call<EVMC_CALL, true>, nullptr, 700, 6, -5};
    table[OP_REVERT] = {op_return<EVMC_REVERT>, nullptr, 0, 2, -2};
    return table;
}
...
constexpr op_table create_op_table_constantinople() noexcept
{
    ...
    table[OP_SHL] = {op<shl>, nullptr, 3, 2, -1};
    table[OP_SHR] = {op<shr>, nullptr, 3, 2, -1};
    table[OP_SAR] = {op<sar>, nullptr, 3, 2, -1};
    table[OP_EXTCODEHASH] = {op<extcodehash>, nullptr, 400, 1, 0};
    table[OP_CREATE2] = {op_create<EVMC_CREATE2>, nullptr, 32000, 4, -3};
    return table;
}
...
constexpr op_table create_op_table_istanbul() noexcept
{
    ...
    table[OP_BALANCE] = {op<balance>, nullptr, 700, 1, 0};
    table[OP_CHAINID] = {op<chainid>, nullptr, 2, 0, 1};
    table[OP_EXTCODEHASH] = {op<extcodehash>, nullptr, 700, 1, 0};
    table[OP_SELFBALANCE] = {op<selfbalance>, nullptr, 5, 0, 1};
    table[OP_SLOAD] = {op<sload>, nullptr, 800, 1, 0};
    return table;
}
